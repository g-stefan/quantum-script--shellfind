...
echo -^> local-release quantum-script-extension-shellfind
...
call :cmdX xyo-cc quantum-script-extension-shellfind --archive-release-sha512 --version-file=source/quantum-script-extension-shellfind.version.ini
