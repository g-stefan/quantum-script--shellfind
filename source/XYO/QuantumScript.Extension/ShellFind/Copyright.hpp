...
namespace XYO::QuantumScript::Extension::ShellFind::Copyright {
	XYO_QUANTUMSCRIPT_EXTENSION_SHELLFIND_EXPORT const char *copyright();
	XYO_QUANTUMSCRIPT_EXTENSION_SHELLFIND_EXPORT const char *publisher();
	XYO_QUANTUMSCRIPT_EXTENSION_SHELLFIND_EXPORT const char *company();
	XYO_QUANTUMSCRIPT_EXTENSION_SHELLFIND_EXPORT const char *contact();
	XYO_QUANTUMSCRIPT_EXTENSION_SHELLFIND_EXPORT const char *fullCopyright();
};
